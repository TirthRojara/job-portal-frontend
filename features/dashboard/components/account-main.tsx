...
export default function AccountMain() {
    return (
        <div className="">
            <div className="flex gap-4 items-center p-3 sm:p-10">
                    ...
                    <Tabs defaultValue="account" className="w-full">
                        <TabsList className="flex w-full justify-start rounded-none border-b bg-transparent p-0">
                            <TabsTrigger
                                value="account"
                                // KEY FIXES:
                                // 1. 'flex-none': Prevents the tab from growing to fill space (overrides flex-1).
                                // 2. 'w-auto': Forces width to match content + padding.
